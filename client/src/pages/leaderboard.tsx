      ...
      <header className="border-b bg-[#0A1B3B] text-white shadow-lg">
        <div className="container mx-auto flex h-14 items-center justify-between px-4">
          ...
          <Link href="/admin/login">
            <button className="text-sm px-3 py-1.5 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300">
              Admin Login
            </button>
          </Link>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr,280px]">
          <div className="space-y-3 overflow-x-auto pb-2">
            {isLoading ? (
              ...
              <div className="space-y-3 min-w-[800px] lg:min-w-0">
                {/* Table Header */}
                <div className="grid grid-cols-5 gap-4 py-2 px-4 bg-gray-50 rounded-lg font-medium text-sm">
                  <div>Name</div>
          ...
          <Card className="h-fit bg-white border-t-4 border-t-[#00B140] shadow-md">
            ...
            <CardContent className="space-y-4">
              <div className="relative pl-7">
                ...
                <h3 className="font-medium text-gray-900">Board Revenue</h3>
              ...
              <div className="relative pl-7">
                ...
                <h3 className="font-medium text-gray-900">MSP Revenue</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="relative pl-7">
                ...
                <h3 className="font-medium text-gray-900">Voice Seats</h3>
                <p className="text-sm text-gray-600">
                  10 points per seat
                </p>
              </div>
              <div className="relative pl-7">
                ...
                <h3 className="font-medium text-gray-900">Total Deals</h3>
                <p className="text-sm text-gray-600">
                  50 points per deal
                </p>
              </div>
